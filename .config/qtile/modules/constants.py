...
GROUP_NAMES = [
    ...
    {'key_name': KP['2'], 'name': 'CHAT', 'matches': ["telegram-desktop", "Pavucontrol", "whatsie"]},
    ...
    {'key_name': KP['7'], 'name': 'DEV2',  'matches': ["Alacritty", "Code", "jetbrains-pycharm"]},
    {'key_name': KP['8'], 'name': 'DOCS', 'matches': ["Nemo"]},
